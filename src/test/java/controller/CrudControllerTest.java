...
public class CrudControllerTest {
    ...
    private static final String DB_UNIT_DRIVER_CONNECTION_URL = "jdbc:h2:mem:default;DB_CLOSE_DELAY=-1;init=runscript from '/home/maciek/Templates/Studia/testy/TestOprogCRUD/src/test/resources/users_schema.sql'";
    private static final String DB_UNIT_CONNECTION_URL_SHORT = "jdbc:h2:mem:default";
    private static final String MOCK_DATABASE_DIR = "/home/maciek/Templates/Studia/testy/TestOprogCRUD/src/test/resources/users_mock.xml";
    ...
    public void setup() throws Exception {
        ...
        controller = new CrudController(DB_UNIT_CONNECTION_URL_SHORT,USERNAME,PASSWORD);
    }
    ...
    public void create_WithUser_Correct() throws Exception {
        ...
        ITable resultingTable = databaseTester.getConnection().createQueryTable("users","SELECT * FROM users");
        assertEquals(resultingTable,defaultTable);
